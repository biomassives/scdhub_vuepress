<template><div><p>three major carbon sequestration technologies: Carbon Capture and Storage (CCS), Bioenergy with Carbon Capture and Storage (BECCS), and Direct Air Capture (DAC).</p>
<p>Please note that the figures provided are estimates and may vary depending on specific projects and regions.</p>
<pre><code>- Carbon Capture and Storage (CCS)
...
<p>Please keep in mind that these technologies are continuously evolving, and their costs and efficiencies may improve over time. Additionally, it's essential to
consider other factors like geographic location, environmental impacts, and potential risks when evaluating carbon sequestration technologies.</p>
</div></template>
